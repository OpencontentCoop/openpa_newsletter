...
<head>
  ...
  <title>{$#subject}</title>
  {include uri='design:newsletter/skin/entilocali/outputformat/include/style.tpl'}  
</head>
...
<table style="background-color: #D2D3D7; font-family: helvetica, arial, sans-serif; font-size: 12px; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; margin:0; padding:0; width:100% !important; line-height: 100% !important;" cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
  ...
  <tr>
    ...
    <table cellpadding="0" cellspacing="0" border="0" align="center" width="700" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
      ...
      {* header *}
      <tr><td>{include uri='design:newsletter/skin/entilocali/outputformat/include/header.tpl'} </td></tr>
      ...
      <tr>
        <td colspan="2" style="background-color:#FFFFFF;padding-bottom: 20px" align="center" >
          ...
          {if $notizie}
            {include uri='design:newsletter/skin/entilocali/outputformat/include/notizie.tpl' items=$notizie}
          {/if}
          
          {if $comunicati}            
              {switch match=$comunicati|count()}
                  {case match=3}
                     {include uri='design:newsletter/skin/entilocali/outputformat/include/comunicati.tpl' items=array( $comunicati[0] )}   
                     {include uri='design:newsletter/skin/entilocali/outputformat/include/comunicati.tpl' items=array( $comunicati[1], $comunicati[2] )}
                  {/case}
                  {case match=4}
                     {include uri='design:newsletter/skin/entilocali/outputformat/include/comunicati.tpl' items=array( $comunicati[0], $comunicati[1] )}                     
                     {include uri='design:newsletter/skin/entilocali/outputformat/include/comunicati.tpl' items=array( $comunicati[2], $comunicati[3] )}                     
                  {/case}
                  {case match=5}                     
                     {include uri='design:newsletter/skin/entilocali/outputformat/include/comunicati.tpl' items=array( $comunicati[0] )}   
                     {include uri='design:newsletter/skin/entilocali/outputformat/include/comunicati.tpl' items=array( $comunicati[1], $comunicati[2] )}
                     {include uri='design:newsletter/skin/entilocali/outputformat/include/comunicati.tpl' items=array( $comunicati[3], $comunicati[4] )}
                  {/case}
                  {case match=6}
                     {include uri='design:newsletter/skin/entilocali/outputformat/include/comunicati.tpl' items=array( $comunicati[0], $comunicati[1] )}                     
                     {include uri='design:newsletter/skin/entilocali/outputformat/include/comunicati.tpl' items=array( $comunicati[2], $comunicati[3] )}                     
                     {include uri='design:newsletter/skin/entilocali/outputformat/include/comunicati.tpl' items=array( $comunicati[4], $comunicati[5] )}                     
                  {/case}
                  {case}
                     {include uri='design:newsletter/skin/entilocali/outputformat/include/comunicati.tpl' items=$comunicati}
                  {/case}
              {/switch}
          {/if}
          ...
          {if $appuntamenti}                    
              ...
              {switch match=$appuntamenti|count()}
                ...
                {case match=3}
                    {include uri='design:newsletter/skin/entilocali/outputformat/include/appuntamenti.tpl' items=array( $appuntamenti[0] )}   
                    {include uri='design:newsletter/skin/entilocali/outputformat/include/appuntamenti.tpl' items=array( $appuntamenti[1], $appuntamenti[2] )}
                {/case}
                {case match=4}
                   {include uri='design:newsletter/skin/entilocali/outputformat/include/appuntamenti.tpl' items=array( $appuntamenti[0], $appuntamenti[1] )}                     
                   {include uri='design:newsletter/skin/entilocali/outputformat/include/appuntamenti.tpl' items=array( $appuntamenti[2], $appuntamenti[3] )}                     
                {/case}
                {case match=5}                     
                   {include uri='design:newsletter/skin/entilocali/outputformat/include/appuntamenti.tpl' items=array( $appuntamenti[0] )}   
                   {include uri='design:newsletter/skin/entilocali/outputformat/include/appuntamenti.tpl' items=array( $appuntamenti[1], $appuntamenti[2] )}
                   {include uri='design:newsletter/skin/entilocali/outputformat/include/appuntamenti.tpl' items=array( $appuntamenti[3], $appuntamenti[4] )}
                {/case}
                {case match=6}
                   {include uri='design:newsletter/skin/entilocali/outputformat/include/appuntamenti.tpl' items=array( $appuntamenti[0], $appuntamenti[1] )}                     
                   {include uri='design:newsletter/skin/entilocali/outputformat/include/appuntamenti.tpl' items=array( $appuntamenti[2], $appuntamenti[3] )}                     
                   {include uri='design:newsletter/skin/entilocali/outputformat/include/appuntamenti.tpl' items=array( $appuntamenti[4], $appuntamenti[5] )}                     
                {/case}
                {case}
                   {include uri='design:newsletter/skin/entilocali/outputformat/include/appuntamenti.tpl' items=$appuntamenti}
                {/case}
      ...
      <tr><td colspan="2" bgcolor="#222222;">{include uri='design:newsletter/skin/entilocali/outputformat/include/footer.tpl'}</td></tr>   
    </table>
