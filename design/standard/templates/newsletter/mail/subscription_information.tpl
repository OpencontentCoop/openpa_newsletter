{*?template charset=utf-8?*}{set-block variable=$subject scope=root}{ezini('SiteSettings', 'SiteName', 'site.ini')} {'Subscription information'|i18n( 'cjw_newsletter/subscription_information' )}{/set-block}
{*
$newsletter_user
$hostname
*}
