{*?template charset=utf-8?*}{set-block variable=$subject scope=root}{ezini('SiteSettings', 'SiteName', 'site.ini')} {'Subscription verification'|i18n( 'cjw_newsletter/subscription_confirmation' )}{/set-block}
{*
$newsletter_user
$hostname
*}
