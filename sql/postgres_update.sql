...
ALTER TABLE cjwnl_list ADD virtual_filter text NOT NULL;
...
ALTER TABLE cjwnl_user ADD custom_data_text_1 character varying( 255 )  NOT NULL;
ALTER TABLE cjwnl_user ADD custom_data_text_2 character varying( 255 )  NOT NULL;
ALTER TABLE cjwnl_user ADD custom_data_text_3 character varying( 255 )  NOT NULL;
ALTER TABLE cjwnl_user ADD custom_data_text_4 character varying( 255 )  NOT NULL;
